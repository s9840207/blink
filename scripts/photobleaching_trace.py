...
def plot_and_save1 (path, category_path, save_directory):
    ...
    real_n_step = [len(n_step1), len(n_step2), len(n_step3), len(n_step4), len(n_step5)]
    return real_n_step
...
t_path1 = Path(r'D:\CWH\20221222\aoi\dT16_photobleaching_1gb_col_traces.npz')
c_path1 = Path(r'D:\CWH\20221222\aoi\dT16_photobleaching_1gb_col_category.npy')
t_path2 = Path(r'D:\CWH\20221222\aoi\dT16_photobleaching_2gb_col_traces.npz')
c_path2 = Path(r'D:\CWH\20221222\aoi\dT16_photobleaching_2gb_col_category.npy')
exp1 =  plot_and_save1(t_path1, c_path1, save_directory = r"D:\CWH\binding_curve_and_time_trace\dT16_photobleaching_trace_10nM_1")

exp2 =  plot_and_save2(t_path2, c_path2, save_directory = r"D:\CWH\binding_curve_and_time_trace\dT16_photobleaching_trace_10nM_2")
...
# print(total_n_step)
# n = sum(total_n_step)
# print(total_n_step[3]/n)

plt.bar(range(1,(len(exp1)+1)), total_n_step, color = 'darkslategray', label = 'dT16_photobleaching')

plt.xlabel('number of step')
plt.ylabel('number of event')
plt.xticks(np.arange(1,6, step = 1))
plt.legend()
plt.savefig(r'D:\CWH\binding_curve_and_time_trace\dT16_photobleaching_10nM', dpi = 300, bbox_inches='tight')
plt.show()
